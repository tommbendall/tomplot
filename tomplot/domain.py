...
def apply_gusto_domain(ax, dataset, slice_along=None, units=None,
                       vertical_units=None, xlabel=True, ylabel=True,
    ...
    Args:
        ...
        units (str, optional): which units to use for the axes. Valid values
            depend on the domain, but are generally "m", "km", "deg" or "rad".
            Defaults to None
        vertical_units (str, optional): which units to use for the vertical
            coordinates of the domain. Valid values are "m" or "km". Defaults
            to None, in which case it will be overridden by the units argument.
    ...
    if domain == 'spherical_shell':
        ...
        if vertical_units == 'm':
            vertical_unit_factor = 1
            ylabel = r'$z \ / $ m'
        elif vertical_units == 'km':
            vertical_unit_factor = 0.001
            ylabel = r'$z \ / $ km'

        xlims = [0, unit_factor*dataset['domain_extent_x'][:].data]
        ylims = [0, vertical_unit_factor*dataset['domain_extent_z'][:].data]
        ...
        zlims = [0, round(vertical_unit_factor*dataset['domain_extent_z'][:].data, 3)]
